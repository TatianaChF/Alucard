...
export const HospitalRegistration = () => {
    ...
    const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        if (formData.lastname.length < 0) console.log("Введите фамилию!")
                        ...
                        <div>
                            ...
                            <form onSubmit={handleSubmit} className={styles.form_container}>
                                ...
                                <div className={styles.form_input}>
                                    ...
                                    <input required type="text" id="otch" name="otch" value={formData.otch} onChange={handleChange} />
                                </div>
                                <div className={styles.form_input}>
                                ...
                                <div className={styles.form_input}>
                                    ...
                                    <select required id="hospital" name="hospital" value={formData.hospital} onChange={handleChange}>
                                        <option>Выберите из списка</option>
                                ...
                                <div className={styles.form_input}>
                                    ...
                                    <select required id="time" name="time" value={formData.time} onChange={handleChange}>
                                        <option>Выберите из списка</option>
